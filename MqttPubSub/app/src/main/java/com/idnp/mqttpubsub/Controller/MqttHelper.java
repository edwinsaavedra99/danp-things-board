...
public class MqttHelper implements MqttCallback {
    ...
    private final static String HOST = "tcp://demo.thingsboard.io";
    private final static String USERNAME = "NUzzqfs7TRi7pnMFbK40";
    private final static String PASSWORD = "somos7unsa";
        ...
        try {
            ...
            while (MESSAGE_ID2 < messages.size()) {
                ...
                if (mqttAndroidClient.isConnected()) {
                    ...
                    mqttHelperListener.displayMessage(ToolHelper.DATA);
